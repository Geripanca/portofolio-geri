...
function Deskripsi() {
  return (
    <>
      ...
      {/*  */}
      <div class="flex items-center justify-center py-10 border-b-2 overflow-hidden">
        <div class="max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg px-4 sm:px-10 lg:px-20 mx-auto">
          <ol class="relative border-l-4 border-black leading-loose font-libre">
            <li class="mb-10 ml-6 w-full md:w-[350px] lg:w-[400px]">
              <div class="absolute w-4 h-4 bg-white border-4 border-black rounded-full -left-[0.6rem]"></div>

              <p class="font-bold text-base sm:text-lg md:text-xl mb-1">
                SD Negeri 270 Gentra Masekdas
              </p>
              <p class="font-bold text-xs sm:text-sm md:text-base mb-2">
                2007 - 2013
              </p>
            </li>
            <li class="mb-10 ml-6 w-full md:w-[350px] lg:w-[400px]">
            ...
            <li class="mb-10 ml-6 w-full md:w-[350px] lg:w-[400px]">
              ...
              <p class="text-xs sm:text-sm md:text-base">GPA : 3.55</p>
            </li>
          </ol>
        </div>
      </div>
